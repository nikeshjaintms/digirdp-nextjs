...
function Offer() {
    ...
    useEffect(() => {
        axios.get(`${process.env.NEXT_PUBLIC_BACKEND_API_URL}/offers`)
            .then((response) => {
                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-12">
                                <div className="breadcrumb-inner text-center">
                                    <h3 className="title h3">Limited-Time Deals: Save Big on RDP and VPS Services! </h3>
                                    <p className="description b1">Upgrade to high-performance RDP and VPS services without breaking the bank.<br />  Grab our limited-time promo codes and enjoy premium solutions at discounted rates. <br />Don’t miss these limited-time offers—claim your code today and start saving instantly!
                                    </p>
                                    <ul className="page-list">
                                        <li className="rainbow-breadcrumb-item"><Link href="/">Home</Link></li>
                                        <li className="rainbow-breadcrumb-item"><Link href="/">Support</Link></li>
                    ...
                    <div className="container-fluid">
                                                            ...
                                                            <div className="rainbow-card undefined">
                                                                <div className="inner">
                                                                    <div className="thumbnail">
                                                                        <Link className="image" href="/blog-details"><img src={`${assets}/images/added/offer-1.jpg`} alt="Blog" />
                                                                        </Link>
                                                                    </div>
                                                                    <div className="content">
                                                                        ...
                                                                        <Link href={`${offer.url}`} className="btn btn-default btn-default-new btn-icon w-100"><span>{offer.offer_code}</span></Link>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div className="col-lg-12 mt--60">
                                        <div className="advance-tab-button advance-tab-button-1 right-top">
                                            <ul className="nav nav-tabs tab-button-list">
                                                ...
                                                <li className="col-lg-3 nav-item" role="presentation">
                                                    <Link href="/dedicated-server" className="nav-link tab-button">
                                                        <div className="tab">
                                                ...
                                                <li className="col-lg-3 nav-item" role="presentation">
                                                    <Link href="/private_rdp" className="nav-link tab-button">
                                                        <div className="tab">
                        ...
                        <div className="rainbow-testimonial-area rainbow-section-gap">
                            ...
                            <div className="view-more-button text-center mt--45 sal-animate" data-sal="slide-up" data-sal-duration="400" data-sal-delay="400">
                                <Link className="btn-default color-blacked" href="/blog">View Blogs <i className="fa-sharp fa-light fa-arrow-right ml--5"></i></Link>
                            </div>
                        </div>
                        {/* <!-- End blog Area  --> */}
