...
const BlackFriday = () => {
   ...
   useEffect(() => {
    const fetchSalesPageData = async () => {
        try {
            const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_API_URL}/sales_page`);
    ...
    const [couponCode, setCouponCode] = useState(sales.promocode || "STEALDEAL20");
    ...
    var startDate = sales_page.start_date ? sales_page.start_date.replace(" ", "T") : "";
    var endDate = sales_page.end_date ? sales_page.end_date.replace(" ", "T") : "2025-01-31T00:00:00"; // Fallback end date if not provided
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-12">
                            <div className="inner text-center mt--140">
                                ...
                                <h1 className="title display-one"><span class="highlight-1">{sales_page.title_1}</span> </h1>
                                <div id="neon">{sales_page.title_2}</div>   
                                <p className="description p-0">{sales_page.description}</p>
                                <Link className="btn-default @@btnclassName" href={`${sales_page.url}`} > Contact Us Now </Link>
                                                                    ...
                                                                    {salesplan.map((saleplan, index) => (
                                                                        <div className="col-xl-4 col-lg-6 col-md-6 col-12 mt--30">
                                                                            <div className="rainbow-pricing style-aiwave ">
                                                                                <div className="pricing-table-inner">
                                                                                    <div className="pricing-top">
                                                                                        <div className="pricing-header">
                                                                                            <h4 className="title color-var-one">{saleplan.name}</h4>
                                                                                            <div className="pricing">
                                                                                                <span className="price-text">${saleplan.offer_price} </span>
                                                                                                <span className="text d-flex"><span
                                                                                                    style={{ textDecoration: "line-through" }}>{saleplan.price}</span>/Per
                                                                                                    Month</span>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div className="pricing-footer">
                                                                                            <Link className="btn-default" href={saleplan.plan_url}>Buy Now</Link>
                                                                                        </div>
                                                                                        {saleplan.promocode? 
                                                                                        <div className="coupon-card">
                                                                                            <div className="coupon-row">
                                                                                                {/* Display the coupon code dynamically */}
                                                                                                <span id="cpnCode">{saleplan.promocode}</span>
            
                                                                                                {/* The Copy button */}
                                                                                                <span id="cpnBtn" onClick={() => handleCopy(saleplan.promocode, index)}>
                                                                                        ...
                                                                                        <div className="pricing-body">
                                                                                            <div className="features-section has-show-more">
                                                                                                ...
                                                                                                <ul className="list-style--1 has-show-more-inner-content">
                                                                                                    <li>
                                                                                                        <i className="fa-regular fa-circle-check"></i>  {saleplan.users} Users
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-regular fa-circle-check"></i>  {saleplan.processor}
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-regular fa-circle-check"></i>  {saleplan.cpu}
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-regular fa-circle-check"></i> {saleplan.traffic}
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-regular fa-circle-check"></i>  {saleplan.os}
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-regular fa-circle-check"></i>  {saleplan.ram} Ram
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-sharp fa-regular fa-minus-circle"></i> Bandwidth {saleplan.bandwidth}
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-sharp fa-regular fa-minus-circle"></i> IP Address {saleplan.ip}
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-sharp fa-regular fa-minus-circle"></i> {saleplan.drives}
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-sharp fa-regular fa-minus-circle"></i> {saleplan.uptime} uptime
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-sharp fa-regular fa-minus-circle"></i> {saleplan.description}
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <i className="fa-sharp fa-regular fa-minus-circle"></i> {saleplan.free}
                                                                                                    </li>
                                                                                                    {saleplan.a ?
                                                                                                        <li>
                                                                                                            <i className="fa-sharp fa-regular fa-minus-circle"></i> {saleplan.a}
                                                                                                        </li>
                                                                                                        : ""
                                                                                                    }
                                                                                                    {saleplan.b ?
                                                                                                        <li>
                                                                                                            <i className="fa-sharp fa-regular fa-minus-circle"></i> {saleplan.b}
                                                                                                        </li>
                                                                                                        : ""
                                                                                                    }
                                                                                                    {saleplan.c ?
                                                                                                        <li>
                                                                                                            <i className="fa-sharp fa-regular fa-minus-circle"></i> {saleplan.c}
                                                                                                        </li>
                                                                                                        : ""
                                                                                                    }
                                                                                                </ul>
                                                                                ...
                                                                                {saleplan ? <div className="feature-badge">{saleplan.tag}</div> : ""}
                                                                            </div>
                                                                        </div>
                                                                    ))
                                                                                ...
                                                                                <div className="pricing-table-inner">
                                                                                    <div className="pricing-top">
                                                                                        <div className="pricing-header">
                                                                                            <h4 className="title color-var-one">{saleplan.name}</h4>
                                                                                            <div className="pricing">
                                                                                                <span className="price-text">${saleplan.price_annually} </span>
                                                                                                <span className="text d-flex"><span
                                                                                                    style={{ textDecoration: "line-through" }}>{saleplan.price * 12}</span>/Per
                                                                                                    Year</span>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div className="pricing-footer">
                                                                                        ...
                                                                                        <div className="coupon-card">
                                                                                            <div className="coupon-row">
                                                                                                {/* Display the coupon code dynamically */}
                                                                                                <span id="cpnCode">{saleplan.promocode_annually}</span>
            
                                                                                                {/* The Copy button */}
                                                                                                <span id="cpnBtn" onClick={() => handleCopy(saleplan.promocode_annually, index)}>
                                                                                                    {btnTexts[index] || "Copy Code"}
                                                                                                </span>
                                                                                            </div>
                                                                                        </div>
                        ...
                        <div className="col-lg-4">
                            <div className="right-content">
                                <div className="call-to-btn text-start text-lg-end sal-animate" data-sal="slide-up"
                                    ...
                                    <Link className="btn-default" href="/reseller-program">Grow with DigiRDP </Link>
                                </div>
                            </div>
                        </div>
                        <div className="bg-shape">
