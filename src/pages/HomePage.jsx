...
const assets = "/assets";
import { convertCurrency, getClientLocation } from "../utils/currencyUtils";
import currencies from "../currency.json";

const HomePage = ({ vps = {}, index }) => {
  useEffect(() => {
    sal();
  }, []);
      ...
      try {
        ...
        if (foundCurrency) {
          ...
          const response = await axios.get(
            `https://admin.digirdp.chaipost.co.in/api/triooffer`,
            ...
            <div className="col-lg-12">
              <div className="inner text-center mt--140">
                <h1 className="title display-one">
                  Unlock the power of premium <br />
                  <b className="theme-gradient is-visible">
                    {" "}
                    RDP and Cloud VPS servers,
                  </b>
                  <br /> designed for top-tier performance.
                </h1>
                <p className="description">
                  Get started now and elevate your hosting experience with
              ...
              <div className="brand-slider-container">
                <ul className="brand-list brand-style-2 slider-brand">
                  <li className="slide-single-layout">
                    <Link href="/">
                      <img src={`${assets}/images/added/1d.png`} alt="Brand" />
                    </Link>
                  </li>
                  <li className="slide-single-layout">
                    <Link href="/">
                      <img src={`${assets}/images/added/2d.svg`} alt="Brand" />
                    </Link>
                  </li>
                  <li className="slide-single-layout">
                    <Link href="/">
                      <img src={`${assets}/images/added/3d.png`} alt="Brand" />
                    </Link>
                  </li>
                  <li className="slide-single-layout">
                    <Link href="/">
                      <img src={`${assets}/images/added/4d.webp`} alt="Brand" />
                    </Link>
                  </li>
                  <li className="slide-single-layout">
                    <Link href="/">
                      <img src={`${assets}/images/added/5d.png`} alt="Brand" />
                    </Link>
                  </li>
                  <li className="slide-single-layout">
                    <Link href="/">
                      <img src={`${assets}/images/added/6d.png`} alt="Brand" />
                    </Link>
                  </li>
                  <li className="slide-single-layout">
                    <Link href="/">
                      <img src={`${assets}/images/added/7d.svg`} alt="Brand" />
                    </Link>
                  </li>
                </ul>
              </div>
                          ...
                          <div className="col-xl-7 col-sm-6 col-12">
                            <div className="split-inner">
                              ...
                              <p
                                ...
                                data-sal-delay="300"
                              >
                                When you purchase any RDP Plans, you get access
                                to a tools and components to help you working
                                with the page more efficiently.
                              </p>
                              <div
                              ...
                              {vps.promocode ? (
                                <div className="coupon-card">
                                  <div className="coupon-row">
                                    ...
                                    <span id="cpnCode">{vps.promocode}</span>
