    ...
    const fetchcloudvpsplan = async () => {
      ...
      try {
        ...
        if (foundCurrency) {
          ...
          const response = await axios.get(
            `https://admin.digirdp.chaipost.co.in/api/cloud_vps_plan/${url_text}`
          );
      ...
      <div className="main-content">
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="breadcrumb-inner text-center">
                  <h3 className="title h3">{cloudvps && cloudvps.name}</h3>
        ...
        <div className="rainbow-pricing-area rainbow-section-gap">
          <div className="container-fluid">
            {sliders.filter((slider) => slider.page_id === 3).length > 0 && (
                ...
                <div className="container-fluid">
                  ...
                  <div className="burger-slider">
                    <div className="slider-wrapper row">
                      {sliders
                        .filter((slider) => slider.page_id === 3)
                        .map((slider) => (
                          <div
