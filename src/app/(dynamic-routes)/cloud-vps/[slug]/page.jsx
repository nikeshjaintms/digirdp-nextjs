...
//console.log(url_text);
  ...
  const matchedSliders = sliders.filter((slider) => slider.page_id === cloudvps.id);
  const categoryMatchedSliders = sliders.filter(
    (slider) => slider.category_id === 3 && (slider.page_id === 0 || slider.page_id === null)
  );  
  const displayedSliders = matchedSliders.length > 0 ? matchedSliders : categoryMatchedSliders;
