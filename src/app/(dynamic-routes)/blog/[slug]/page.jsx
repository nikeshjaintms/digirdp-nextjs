...
async function getBlogData(slug) {
  try {
    ...
    const response = await fetch(`https://admin.digirdp.chaipost.co.in/api/blog/${slug}`, {
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${blog.meta_title} | DigiRDP - Secure & Fast RDP and Cloud VPS Solutions` || "DigiRDP - Blog",
