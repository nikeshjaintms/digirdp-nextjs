  ...
  return (
    <Fragment>
      <Head>
        ...
        <title>RDP By Location</title>
        <meta
          name="description"
          content="Here for RDP? Look no where else, we will setup Windows RDP tailored to your needs no matter the scale."
        />
      </Head>
      <Header />
