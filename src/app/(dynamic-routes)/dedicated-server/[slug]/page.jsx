...
//console.log(url_text);
  ...
  const matchedSliders = sliders.filter((slider) => slider.page_id === dedicateds.id);
  const categoryMatchedSliders = sliders.filter(
    (slider) => slider.category_id === 2 && (slider.page_id === 0 || slider.page_id === null)
  );  
