...
async function getRdpPlanData() {
  try {
    ...
    const response = await fetch(
      `https://admin.digirdp.chaipost.co.in/api/windows_rdps`,
      {
  ...
  return (
    <>
      <Head>
        ...
        <title>Windows RDP</title>
        <meta
          name="description"
          content="Looking for RDP? You’re in the right place! We provide
