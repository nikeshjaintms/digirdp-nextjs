...
const Career = () => {
    ...
    useEffect(() => {
        axios
            .get("https://admin.digirdp.chaipost.co.in/api/aboutus")
            .then((response) => {
                                        ...
                                        <ul class="job-list">
                                            <li class="job-preview">
                                                <div className="div-career">
                                                    <div class="content float-left">
                                                        ...
                                                        <h4 class="job-title">
                                                            ...
                                                            <p> Posted by Realty Assistant</p>
                                                        </h4>
                                                    </div>
                                                ...
                                                <div className="job-description">
                                                    ...
                                                    {isExpanded1 && (
                                                        <p>
                                                            We are looking for high-performing Sales managers
                                                            to help us meet our customer acquisition and
                                                            revenue growth targets by keeping our company
                                                            competitive and innovative. You will be
                                                            responsible for maximizing our sales team's
                                                            potential, crafting sales plans, and justifying
