              ...
              <div className="col-lg-12">
                <div className="breadcrumb-inner text-center">
                  <h3 className="title h3">
                    Partner with Us: Become a Reseller Today!{" "}
                  </h3>
                  <p className="description b1">
                    Join today and start your journey as a DigiRDP reseller—it's
                    completely free and packed with benefits
                  </p>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="section-title text-center">
                  ...
                  <p>
                    Expand your business effortlessly by joining our
                    hassle-free, dedicated server reseller program. Offer
                    high-performance dedicated servers at unbeatable prices and
                    gain access to exclusive discounts—all with zero hidden
                    fees, no minimum commitments, and no upfront costs.{" "}
                  </p>
                  <p>
                    Our reseller program is designed to help you unlock new
                    opportunities, boost your revenue, and grow your client base
                    with ease. Take your business to the next level and deliver
