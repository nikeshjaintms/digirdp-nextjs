...
function Offer() {
  ...
  useEffect(() => {
    axios
      .get(`https://admin.digirdp.chaipost.co.in/api/offers`)
      .then((response) => {
   ...
   useStaticSEO({
    title: "Limited-Time Deals: Save Big on RDP and VPS Services!",
    description:
      "Upgrade to high-performance RDP and VPS services without breaking the bank. Grab our limited-time promo codes and enjoy premium solutions at discounted rates.",
  });
              ...
              <div className="col-lg-12">
                <div className="breadcrumb-inner text-center">
                  ...
                  <p className="description b1">
                    ...
                    breaking the bank.
                    <br /> Grab our limited-time promo codes and enjoy premium
                    solutions at discounted rates. <br />
                    Don’t miss these limited-time offers—claim your code today
