      ...
      try {
        const response = await axios.post(
          ...
          new URLSearchParams({
            ...
            username: process.env.NEXT_PUBLIC_WHMCS_API_IDENTIFIER,
            password: process.env.NEXT_PUBLIC_WHMCS_API_SECRET,
            responsetype: "json",
          })
        );
                    ...
                    <div className="collapse" id="collapseExampleMenuFour">
                      <ul className="submenu rbt-default-sidebar-list">
                        {rdp_location
                          ...
                          .map((rdp_loc, index) => (
                            <li key={index}>
                              <Link href={`/private_rdp/${rdp_loc.url_text}`}>
                                {rdp_loc.name}
                              </Link>
                            </li>
                          ))}
